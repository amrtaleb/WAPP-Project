<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BM.aspx.cs" Inherits="Course.BM" %>
...
<body>
    <h1>Bahasa Melayu</h1>
    <h2>Have fun to learn Bahasa Melayu easily with SpeakEase!</h2>
    <form id="form1" runat="server">
        <div class="div1">
            ...
            <table align="center">
                <tr>
                    <td>
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="B1.png" OnClientClick="showVideo()" OnClick="ImageButton1_Click" CssClass="button-style2" />
                        <div class="overlay" id="overlay1" runat="server">
                            <div class="video-container">
                                ...
                                <video id="video1" controls="controls" runat="server">
                                    <source src="BMB.mp4" type="video/mp4" />
                                </video>
                            </div>
                        </div>
                    </td>
                    <td>
                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="B2.png" OnClientClick="showVideo()" OnClick="ImageButton2_Click" CssClass="button-style2" />
                    ...
                    <td>
                        <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="B3.png" OnClientClick="showVideo()" OnClick="ImageButton3_Click" CssClass="button-style2" />
                        <div class="overlay" id="overlay3" runat="server">
                            <div class="video-container">
                                ...
                                <video id="video3" controls="controls" runat="server">
                                    <source src="BME.mp4" type="video/mp4" />
                                </video>
                            </div>
                        </div>
                    </td>
