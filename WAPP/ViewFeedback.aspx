<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewFeedback.aspx.cs" Inherits="WAPP.ViewFeedback" %>
...
<body>
  ...
  <section id="navbar">
    ...
    <form id="form1" runat="server" class="form-content2">
         <%--<table class="list">
                <tr>
                    <th>Username</th>
                    <th>Email Address</th>
        ...
        <table class="user">
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="rating" runat="server" Width="500px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="comment" runat="server" Width="500px" Height="200px"></asp:TextBox>
                    </td>
                </tr>
            </table>
      
            <asp:Button ID="Delete" runat="server" OnClick="Delete_Click" Text="Delete" CssClass="deleteBtn" />
    </form>
        </div>
    <!--footer -->
    <footer>
